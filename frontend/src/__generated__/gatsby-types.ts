...
type SanityProgram = SanityDocument & Node & {
  readonly _id: Maybe<Scalars['String']>;
  readonly _type: Maybe<Scalars['String']>;
  readonly _createdAt: Maybe<Scalars['Date']>;
  readonly _updatedAt: Maybe<Scalars['Date']>;
...
type SanityProgram__createdAtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type SanityProgram__updatedAtArgs = {
  formatString: Maybe<Scalars['String']>;
  fromNow: Maybe<Scalars['Boolean']>;
  difference: Maybe<Scalars['String']>;
  locale: Maybe<Scalars['String']>;
...
type SanityProgram__rawImageArgs = {
  resolveReferences: Maybe<SanityResolveReferencesConfiguration>;
};
...
type Query = {
  ...
  readonly sanityProgram: Maybe<SanityProgram>;
  readonly allSanityProgram: SanityProgramConnection;
...
type Query_allSanityProgramArgs = {
  filter: Maybe<SanityProgramFilterInput>;
  sort: Maybe<SanityProgramSortInput>;
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
};
...
type SanityProgramConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<SanityProgramEdge>;
  readonly nodes: ReadonlyArray<SanityProgram>;
  readonly pageInfo: PageInfo;
  readonly distinct: ReadonlyArray<Scalars['String']>;
  readonly max: Maybe<Scalars['Float']>;
  readonly min: Maybe<Scalars['Float']>;
  readonly sum: Maybe<Scalars['Float']>;
  readonly group: ReadonlyArray<SanityProgramGroupConnection>;
};


type SanityProgramConnection_distinctArgs = {
  field: SanityProgramFieldsEnum;
};


type SanityProgramConnection_maxArgs = {
  field: SanityProgramFieldsEnum;
};


type SanityProgramConnection_minArgs = {
  field: SanityProgramFieldsEnum;
};


type SanityProgramConnection_sumArgs = {
  field: SanityProgramFieldsEnum;
};


type SanityProgramConnection_groupArgs = {
  skip: Maybe<Scalars['Int']>;
  limit: Maybe<Scalars['Int']>;
  field: SanityProgramFieldsEnum;
};

type SanityProgramEdge = {
  readonly next: Maybe<SanityProgram>;
  readonly node: SanityProgram;
  readonly previous: Maybe<SanityProgram>;
};

type SanityProgramFieldsEnum =
  | '_id'
  | '_type'
  | '_createdAt'
  | '_updatedAt'
...
type SanityProgramGroupConnection = {
  readonly totalCount: Scalars['Int'];
  readonly edges: ReadonlyArray<SanityProgramEdge>;
  readonly nodes: ReadonlyArray<SanityProgram>;
  readonly pageInfo: PageInfo;
...
type SanityProgramSortInput = {
  readonly fields: Maybe<ReadonlyArray<Maybe<SanityProgramFieldsEnum>>>;
  readonly order: Maybe<ReadonlyArray<Maybe<SortOrderEnum>>>;
};
